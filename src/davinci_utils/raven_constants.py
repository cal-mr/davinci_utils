...
class Frames:
    ...
    LeftTool = 'one_tool_base_link'
    RightTool = 'two_tool_base_link'
    LeftRCM = 'one_remote_center_link'
    RightRCM = 'two_remote_center_link'
    World = 'world'
    LeftBase = 'one_psm_base_link'
    RightBase = 'two_psm_base_link'
